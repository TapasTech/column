...
ds.dataset_columns.create(name: 'month', column_type: 'String')
ds.dataset_columns.create(name: 'price', column_type: 'String')
...
ds.dataset_columns.create(name: 'month', column_type: 'String')
ds.dataset_columns.create(name: 'index', column_type: 'String')
